...
<el-button type="primary" @click="add" separator-class="el-icon-arrow-right">添加角色</el-button>
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button size="mini" icon="el-icon-delete" type="danger" @click="del(scope.$index, scope.row)"
              >删除</el-button
            >
            <el-button size="mini" type="warning" icon="el-icon-setting" @click="jurysd(scope.$index, scope.row)">分配权限</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-card>
